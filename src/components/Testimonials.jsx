...
const Testimonials = () => {
    const testimonies = [
        ...
        {text: "Dle mě je to skvěle pojaté. Kdo je fanouškem Japonska nebo šermu s katanami, tak se tu určitě najde. Trenér Choki Vás toho hodne naučí a trenérka Barča se zaměřuje na očistu mysli, správné držení těla a dýchání, celkově bomba aktivita ve skvělém kolektivu lidí", person: "Honza"},
        {text: "Na trénincích si přijdu skvěleJsou tu lidé, co mi rozumí, klidní a chápaví trenéři,kteří tomu věnují čas a baví je to.>Konečně moje krevní vrstva", person: "Riki"},
